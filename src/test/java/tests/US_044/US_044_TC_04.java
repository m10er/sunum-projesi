...
public class US_044_TC_04 extends BaseClass {


    @Test(groups = {"e2e","regression"})
    public void tc_04(){
        test = extent.createTest("US_043_TC_04","4-Kendi eklediğim kategoriyi öne çıkan kategoriler listesine" +
        ...
        clickSaveButton();
        test.info("KUllanici ordera verdigi degerein en ustte oldugunu gorur");
