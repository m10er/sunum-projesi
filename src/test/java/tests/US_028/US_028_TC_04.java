...
public class US_028_TC_04 extends BaseClass {
    @Test(groups = {"e2e","regression"})
    public void tc_04(){
        test = extent.createTest  ("US_026_TC_04",
        ...
        test.pass("Salary Rangers menuye ekledigi maas araliklarini duzenleyebilmeli");
